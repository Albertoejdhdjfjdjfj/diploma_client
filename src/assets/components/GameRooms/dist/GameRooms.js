...
var GameRooms = function () {
    var _a = react_1.useState(undefined), gameRooms = _a[0], setGameRooms = _a[1];
    var _b = react_redux_1.useSelector(function (state) { return state.gameRooms; }), sort = _b.sort, page = _b.page, limit = _b.limit;
    var _c = client_1.useLazyQuery(queries_1.GET_GAME_ROOMS, {
        variables: { sort: sort, page: page, limit: limit },
        notifyOnNetworkStatusChange: true,
        fetchPolicy: 'no-cache'
    }), getGameRooms = _c[0], _d = _c[1], loading = _d.loading, error = _d.error;
    ...
    var handleGetRooms = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getGameRooms()];
                case 1:
                    data = (_a.sent()).data;
    ...
    return (React.createElement("div", { className: "game_rooms" },
        React.createElement(GameRoomsFilter_1["default"], null),
        React.createElement("div", { className: "game_rooms_columns" },
        ...
        error && React.createElement("div", null,
            "Error! ",
            error.message),
        React.createElement("div", { className: "rooms" }, gameRooms && gameRooms.map(function (game_room) { return React.createElement(GameRoomBlock_1["default"], { game_room: game_room }); })),
