...
var App = function () {
  ...
  var content = react_redux_1.useSelector(function (state) {
    return state.notifications.content;
  });
  ...
  var handleActiveGame = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var data;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, getActiveGame()];
          case 1:
            data = _a.sent().data;
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(react_router_dom_1.Route, {
        path: '/',
        element: React.createElement(Main_1['default'], null)
      }),
      React.createElement(react_router_dom_1.Route, {
        path: '/game',
        element: React.createElement(Game_1['default'], null)
      }),
      React.createElement(react_router_dom_1.Route, {
        path: '/logIn',
      ...
      React.createElement(react_router_dom_1.Route, {
        path: '/signUp',
        element: React.createElement(SignUp_1['default'], null)
      }),
      React.createElement(react_router_dom_1.Route, {
        path: '/create',
        element: React.createElement(CreateGameRoom_1['default'], null)
      })
    )
  );
};
